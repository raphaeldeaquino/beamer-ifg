...
Modelo de slides em LaTeX do Instituto Federal de Goiás (IFG).

Modelo canônico para apresentações.
...
Se você quer ter uma ideia de como é o modelo, a compilação deve resultar no seguinte [PDF](../../../beamer-ifg/blob/master/slides.pdf).


## Material de apoio

Para aprender a utilizar LaTeX assista o minicurso ministrado em 10/02/2021 disponível [aqui](https://youtu.be/wiBXE6SDb9k).
...
```bash
git clone --recursive https://github.com/raphaeldeaquino/beamer-ifg
```

Este repositório já contém um exemplo de slides com uso avançado de conceitos e LaTeX. 
...
Para isso altere os dados fictícios para os corretos no arquivo `slides.tex`, que é o arquivo principal do **template** utilizado, carrega todos os pacotes necessários e inclui os arquivos LaTeX que contém as partes da sua dissertação.
...
Você também pode fazer o *upload* automaticamente para Overleaf com a última versão disponível clicando [aqui](https://overleaf.com/docs?snip_uri=https://github.com/raphaeldeaquino/beamer-ifg/archive/main.zip).
...
Copyright (c) 2023 Raphael Gomes
